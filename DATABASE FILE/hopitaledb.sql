...
(1, 'Mariam Moumen', 'maraim@gmail.com', '123@', '117 Blecker Street', '7410696969');
...
(1, 'mohamed rabiai', 'mhmd@mail.com', 'password123', '52 Kelly Drive', '3240006965', 4, 'none'),
...
(1, 'Danny', 'danny@mail.com', 'acc8520', '86 Courtright Street', '4455668877'),
...
(1, 'saad', 'saad@mail.com', 'password', '44 Burton Avenue', '2354547878', 'male', '03/04/1981', 34, 'B+', 1448984171),
(3, 'Marouane', 'mar@mail.com', 'password', '7775 Alac Avenue', '7450002650', 'male', '03/31/1990', 32, 'AB+', 1620900518),
...
-- Prescription liée à un docteur et un patient
ALTER TABLE `prescription`
  ADD FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Allotement de lit lié à un patient et un lit
ALTER TABLE `bed_allotment`
  ADD FOREIGN KEY (`bed_id`) REFERENCES `bed` (`bed_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Médicament lié à sa catégorie
ALTER TABLE `medicine`
  ADD FOREIGN KEY (`medicine_category_id`) REFERENCES `medicine_category` (`medicine_category_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Rapport de diagnostic lié à docteur, admin et patient
ALTER TABLE `diagnosis_report`
  ADD FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD FOREIGN KEY (`admin_id`) REFERENCES `admin` (`admin_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Rendez-vous lié à un patient et un docteur
ALTER TABLE `appointment`
  ADD FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
---- Ajouter la colonne admin_id à la table report
ALTER TABLE `report`
ADD COLUMN `admin_id` int(11) NOT NULL,
