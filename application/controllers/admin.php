...
class Admin extends CI_Controller
{
	...
	function dashboard()
	{
		...
		$page_data['page_title'] = ('Tableau de bord d\'admin');
	...
	function manage_doctor($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['page_title'] = ('Gérer docteur');
	...
	function manage_patient($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['page_title'] = ('Gérer les patients');
	...
	function manage_nurse($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['page_title'] = ('Gérer les Infirmiers');
	...
	function view_appointment($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['page_title']   = ('Voir les rendez-vous');
	...
	function view_blood_bank($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['page_title']   = ('Vior banque du sang');
	...
	function view_report($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['page_title']  = ('Voir Rapport de ' . $param1 );
	...
	function view_medicine($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['page_title'] = ('Voir les médicaments');
	...
	function system_settings($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['page_title'] = ('Paramètres de Système');
