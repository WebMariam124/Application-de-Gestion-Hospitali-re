...

{
...

	{
		...
		$page_data['page_title'] = ('Tableu de bord de docteur');
...

	{
		...
		$page_data['page_title']   = ('Gérer les rendez-vous');
...

	{
		...
		$page_data['page_title']    = ('Gérer les Prescriptions');
...

	{
		...
		if ($param1 == 'create') {
			...
			redirect(base_url() . 'index.php?doctor/manage_medicine_category', 'refresh');
		...
		$page_data['page_title']          = ('Gérer catégorie des médicaments');
...

	{
		...
		if ($param1 == 'create') {
			...
			redirect(base_url() . 'index.php?doctor/manage_medicine', 'refresh');
		...
		$page_data['page_title'] = ('Gérer les médicaments');
...

	{
		...
		$page_data['page_title']    = ('Gérer l\'attribution des lits');
...

	{
		...
		$page_data['page_title'] = ('Gérer les rapports');
